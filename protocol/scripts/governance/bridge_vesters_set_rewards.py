...
########################################################################## 
GOV_MODULE_ADDRESS="btoro10d07y265gmmuvt4z0w9aw880jnsr700jnmapky" # Governance module account
COMMUNITY_VESTER_ADDRESS="btoro1wxje320an3karyc6mjw4zghs300dmrjkwn7xtk"
REWARDS_VESTER_ADDRESS="btoro1ltyc6y4skclzafvpznpt2qjwmfwgsndp458rmp"
DELAY_MSG_MODULE_ADDRESS="btoro1mkkvp26dngu6n8rmalaxyp3gwkjuzztq5zx6tr"
...
proposal_template = {
    ...
    "messages": [
        {
            "@type": "/bitoroprotocol.sending.MsgSendFromModuleToAccount",
        ...
        {
            "@type": "/bitoroprotocol.rewards.MsgUpdateParams",
            "authority": GOV_MODULE_ADDRESS,
            "params": {
...
for delayed_block_number, new_fee_multiplier in [
    ...
    proposal_template["messages"].append(
        {
            "@type": "/bitoroprotocol.delaymsg.MsgDelayMessage",
            "authority": GOV_MODULE_ADDRESS,
            "msg": {
                "@type": "/bitoroprotocol.rewards.MsgUpdateParams",
