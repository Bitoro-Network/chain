...
MAINNET_URL_BASE = "https://bitoro-ops-rest.kingnodes.com"
MARKETMAP_URL = f"{MAINNET_URL_BASE}/slinky/marketmap/v1/marketmap"
PERPETUALS_URL = f"{MAINNET_URL_BASE}/bitoroprotocol/perpetuals/perpetual?pagination.limit=10000"
CLOB_URL = f"{MAINNET_URL_BASE}/bitoroprotocol/clob/clob_pair?pagination.limit=10000"
...
def main():
    ...
    proposal = {
        ...
        "deposit":"2000000000000000000000abtoro"
    }
    ...
    for ticker in TICKERS_TO_DELIST:
        ...
        clob_delisting_message["@type"] = "/bitoroprotocol.clob.MsgUpdateClobPair"
        clob_delisting_message["authority"] = "btoro10d07y265gmmuvt4z0w9aw880jnsr700jnmapky"
    ...
    marketmap_disable_message["authority"] = "btoro10d07y265gmmuvt4z0w9aw880jnsr700jnmapky"
