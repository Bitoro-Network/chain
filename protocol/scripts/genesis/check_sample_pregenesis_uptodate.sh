...
sed 's/.*"app_version":.*//g' "/tmp/prod-chain/.bitoroprotocol/config/sorted_genesis.json" > "/tmp/prod-chain/.bitoroprotocol/config/sorted_genesis.json.stripped"
...
diff_output=$(diff "/tmp/prod-chain/.bitoroprotocol/config/sorted_genesis.json.stripped" "/tmp/sample_pregenesis.json.stripped")
