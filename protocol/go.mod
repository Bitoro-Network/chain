...
replace (
	...
	github.com/cosmos/ibc-go/v8 => github.com/bitoro-network/ibc-go/v8 v8.0.0-rc.0.0.20250312180215-8733b3edf43a
...
replace (
	...
	// Use Bitoro fork of Cosmos SDK/store
	cosmossdk.io/store => github.com/bitoro-network/cosmos-sdk/store v1.0.3-0.20240326192503-dd116391188d
	// Use Bitoro fork of CometBFT
	github.com/cometbft/cometbft => github.com/bitoro-network/cometbft v0.38.6-0.20250203202601-3ab07f44e83a
	...
	// Use Bitoro fork of Cosmos SDK
	github.com/cosmos/cosmos-sdk => github.com/bitoro-network/cosmos-sdk v0.50.6-0.20250113155252-f00c500eaff3
	github.com/cosmos/iavl => github.com/bitoro-network/iavl v1.1.1-0.20240509161911-1c8b8e787e85
)

replace (
	// Copy over the same replace functions for Cosmos SDK.
	// https://github.com/bitoro-network/cosmos-sdk/blob/fbb26831d28f66e86bfc31283b4be9290929a4a5/go.mod#L171
