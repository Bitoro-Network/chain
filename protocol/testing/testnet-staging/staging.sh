...
MNEMONICS=(
	...
	# emily
	# Consensus Address: btorovalcons1zpt0ck6ttuhjm97apawa54ffgthst34u3peqc0
	...
	# fiona
	# Consensus Address: btorovalcons14wwueldgtrdjrmx23wcuwk83keywe5w0pfn94t
	...
	# greg
	# Consensus Address: btorovalcons15yzv3qacs0z2jgm5ecn4ywjkvwc6dl63a2za0p
	...
	# henry
	# Consensus Address: btorovalcons1pggt0hc2drw0j9456vwpu9wmav67h90h03p3h9
	...
	# ian
	# Consensus Address: btorovalcons167ajkznjs3wfa565n9emqmey0c2h69ympf0tmk
	...
	# jeff
	# Consensus Address: btorovalcons1ehwtcwwh25ftac3khhz0jn7wd9053xfeqdwes4
...
TEST_ACCOUNTS=(
	...
	"btoro1966p9acs4mpgj40g3awctfvgrz0mnx8w5vc4sz" # emily
	"btoro18swhz9sgh8ecjaz3cm0v53llw0qzm5se026rsn" # fiona
	"btoro1df84hz7y0dd3mrqcv3vrhw9wdttelul8edqmvp" # greg
	"btoro16h7p7f4dysrgtzptxx2gtpt5d8t834g9dj830z" # henry
	"btoro15u9tppy5e2pdndvlrvafxqhuurj9mnpdstzj6z" # ian
	"btoro168pjt8rkru35239fsqvz7rzgeclakp49zx3aum" # jeff
)
