...
rm "$DAEMON_HOME/cosmovisor/genesis/bin/bitoroprotocold"
ln -s /bin/bitoroprotocold_preupgrade "$DAEMON_HOME/cosmovisor/genesis/bin/bitoroprotocold"
mkdir -p "$DAEMON_HOME/cosmovisor/upgrades/$UPGRADE_TO_VERSION/bin/"
ln -s /bin/bitoroprotocold "$DAEMON_HOME/cosmovisor/upgrades/$UPGRADE_TO_VERSION/bin/bitoroprotocold"
