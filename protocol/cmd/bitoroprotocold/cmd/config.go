...
const (
	...
	// TODO(GENESIS): `adv4tnt` is a placeholder for the stake token of the Bitoro chain.
...
// BitoroAppConfig specifies Bitoro app specific config.
type BitoroAppConfig struct {
	serverconfig.Config
...
func initAppConfig() (string, *BitoroAppConfig) {
...
func initTendermintConfig() *tmcfg.Config {
	...
	// (https://github.com/bitoro-network/tendermint/blob/dc03b21cf5d54c641e1d14b14fae5920fa7ba656/config/config.go#L982)
