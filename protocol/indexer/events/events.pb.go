...
type FundingUpdateV1 struct {
	...
	FundingIndex github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/Bitoro-Network/chain/protocol/dtypes.SerializableInt" json:"funding_index"`
}
...
type AddressTradingReward struct {
	...
	DenomAmount github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=denom_amount,json=denomAmount,proto3,customtype=github.com/Bitoro-Network/chain/protocol/dtypes.SerializableInt" json:"denom_amount"`
}
...
type OpenInterestUpdate struct {
	...
	OpenInterest github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=open_interest,json=openInterest,proto3,customtype=github.com/Bitoro-Network/chain/protocol/dtypes.SerializableInt" json:"open_interest"`
}
...
func init() {
	proto.RegisterFile("bitoroprotocol/indexer/events/events.proto", fileDescriptor_6331dfb59c6fd2bb)
}
