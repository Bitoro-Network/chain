...
// source: bitoroprotocol/indexer/off_chain_updates/off_chain_updates.proto
...
import (
	...
	types2 "github.com/bitoro-network/chain/protocol/indexer/shared/types"
...
func (OrderPlaceV1_OrderPlacementStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eef218ac818dacba, []int{0, 0}
}
...
func (OrderRemoveV1_OrderRemovalStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eef218ac818dacba, []int{1, 0}
}
...
type OrderPlaceV1 struct {
	...
	PlacementStatus OrderPlaceV1_OrderPlacementStatus `protobuf:"varint,2,opt,name=placement_status,json=placementStatus,proto3,enum=bitoroprotocol.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus" json:"placement_status,omitempty"`
...
func (*OrderPlaceV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_eef218ac818dacba, []int{0}
}
...
type OrderRemoveV1 struct {
	...
	Reason         types2.OrderRemovalReason        `protobuf:"varint,2,opt,name=reason,proto3,enum=bitoroprotocol.indexer.shared.OrderRemovalReason" json:"reason,omitempty"`
	RemovalStatus  OrderRemoveV1_OrderRemovalStatus `protobuf:"varint,3,opt,name=removal_status,json=removalStatus,proto3,enum=bitoroprotocol.indexer.off_chain_updates.OrderRemoveV1_OrderRemovalStatus" json:"removal_status,omitempty"`
...
func (*OrderRemoveV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_eef218ac818dacba, []int{1}
}
...
func (*OrderUpdateV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_eef218ac818dacba, []int{2}
}
...
type OrderReplaceV1 struct {
	...
	PlacementStatus OrderPlaceV1_OrderPlacementStatus `protobuf:"varint,3,opt,name=placement_status,json=placementStatus,proto3,enum=bitoroprotocol.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus" json:"placement_status,omitempty"`
	TimeStamp       *time.Time                        `protobuf:"bytes,4,opt,name=time_stamp,json=timeStamp,proto3,stdtime" json:"time_stamp,omitempty"`
}
...
func (*OrderReplaceV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_eef218ac818dacba, []int{3}
}
...
func (*OffChainUpdateV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_eef218ac818dacba, []int{4}
}
...
func init() {
	proto.RegisterEnum("bitoroprotocol.indexer.off_chain_updates.OrderPlaceV1_OrderPlacementStatus", OrderPlaceV1_OrderPlacementStatus_name, OrderPlaceV1_OrderPlacementStatus_value)
	proto.RegisterEnum("bitoroprotocol.indexer.off_chain_updates.OrderRemoveV1_OrderRemovalStatus", OrderRemoveV1_OrderRemovalStatus_name, OrderRemoveV1_OrderRemovalStatus_value)
	proto.RegisterType((*OrderPlaceV1)(nil), "bitoroprotocol.indexer.off_chain_updates.OrderPlaceV1")
	proto.RegisterType((*OrderRemoveV1)(nil), "bitoroprotocol.indexer.off_chain_updates.OrderRemoveV1")
	proto.RegisterType((*OrderUpdateV1)(nil), "bitoroprotocol.indexer.off_chain_updates.OrderUpdateV1")
	proto.RegisterType((*OrderReplaceV1)(nil), "bitoroprotocol.indexer.off_chain_updates.OrderReplaceV1")
	proto.RegisterType((*OffChainUpdateV1)(nil), "bitoroprotocol.indexer.off_chain_updates.OffChainUpdateV1")
}

func init() {
	proto.RegisterFile("bitoroprotocol/indexer/off_chain_updates/off_chain_updates.proto", fileDescriptor_eef218ac818dacba)
}

var fileDescriptor_eef218ac818dacba = []byte{
	// 757 bytes of a gzipped FileDescriptorProto
	,
}
