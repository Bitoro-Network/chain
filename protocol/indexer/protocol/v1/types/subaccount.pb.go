...
type IndexerPerpetualPosition struct {
	...
	FundingPayment github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=funding_payment,json=fundingPayment,proto3,customtype=github.com/Bitoro-Network/chain/protocol/dtypes.SerializableInt" json:"funding_payment"`
}
...
func init() {
	proto.RegisterFile("bitoroprotocol/indexer/protocol/v1/subaccount.proto", fileDescriptor_4c5845963309ad8f)
}
