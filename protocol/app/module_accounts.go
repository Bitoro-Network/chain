...
func init() {
	// SetAddressPrefixes() explicitly in order to set the `btoro` address prefixes.
	config.SetAddressPrefixes()
}

var (
	// Module account permissions. Contains all module accounts on Bitoro chain.
