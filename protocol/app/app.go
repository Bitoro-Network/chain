...
import (
	...
	antetypes "github.com/bitoro-network/chain/protocol/app/ante/types"
	...
	"github.com/bitoro-network/chain/protocol/app/vote_extensions"
	...
	// Mempool
	"github.com/bitoro-network/chain/protocol/mempool"

	// Daemons
	bridgeclient "github.com/bitoro-network/chain/protocol/daemons/bridge/client"
	...
	liquidationclient "github.com/bitoro-network/chain/protocol/daemons/liquidation/client"
	metricsclient "github.com/bitoro-network/chain/protocol/daemons/metrics/client"
	pricefeedclient "github.com/bitoro-network/chain/protocol/daemons/pricefeed/client"
	...
	daemonserver "github.com/bitoro-network/chain/protocol/daemons/server"
	daemonservertypes "github.com/bitoro-network/chain/protocol/daemons/server/types"
	bridgedaemontypes "github.com/bitoro-network/chain/protocol/daemons/server/types/bridge"
	...
	slinkyclient "github.com/bitoro-network/chain/protocol/daemons/slinky/client"
	...
	accountplusmodulekeeper "github.com/bitoro-network/chain/protocol/x/accountplus/keeper"
	accountplusmoduletypes "github.com/bitoro-network/chain/protocol/x/accountplus/types"
	affiliatesmodule "github.com/bitoro-network/chain/protocol/x/affiliates"
	affiliatesmodulekeeper "github.com/bitoro-network/chain/protocol/x/affiliates/keeper"
	affiliatesmoduletypes "github.com/bitoro-network/chain/protocol/x/affiliates/types"
	assetsmodule "github.com/bitoro-network/chain/protocol/x/assets"
	assetsmodulekeeper "github.com/bitoro-network/chain/protocol/x/assets/keeper"
	assetsmoduletypes "github.com/bitoro-network/chain/protocol/x/assets/types"
	blocktimemodule "github.com/bitoro-network/chain/protocol/x/blocktime"
	blocktimemodulekeeper "github.com/bitoro-network/chain/protocol/x/blocktime/keeper"
	blocktimemoduletypes "github.com/bitoro-network/chain/protocol/x/blocktime/types"
	bridgemodule "github.com/bitoro-network/chain/protocol/x/bridge"
	bridgemodulekeeper "github.com/bitoro-network/chain/protocol/x/bridge/keeper"
	...
	clobmodulekeeper "github.com/bitoro-network/chain/protocol/x/clob/keeper"
	clobmodulememclob "github.com/bitoro-network/chain/protocol/x/clob/memclob"
	clobmoduletypes "github.com/bitoro-network/chain/protocol/x/clob/types"
	delaymsgmodule "github.com/bitoro-network/chain/protocol/x/delaymsg"
	delaymsgmodulekeeper "github.com/bitoro-network/chain/protocol/x/delaymsg/keeper"
	delaymsgmoduletypes "github.com/bitoro-network/chain/protocol/x/delaymsg/types"
	epochsmodule "github.com/bitoro-network/chain/protocol/x/epochs"
	epochsmodulekeeper "github.com/bitoro-network/chain/protocol/x/epochs/keeper"
	epochsmoduletypes "github.com/bitoro-network/chain/protocol/x/epochs/types"
	feetiersmodule "github.com/bitoro-network/chain/protocol/x/feetiers"
	feetiersmodulekeeper "github.com/bitoro-network/chain/protocol/x/feetiers/keeper"
	feetiersmoduletypes "github.com/bitoro-network/chain/protocol/x/feetiers/types"
	govplusmodule "github.com/bitoro-network/chain/protocol/x/govplus"
	govplusmodulekeeper "github.com/bitoro-network/chain/protocol/x/govplus/keeper"
	govplusmoduletypes "github.com/bitoro-network/chain/protocol/x/govplus/types"
	listingmodule "github.com/bitoro-network/chain/protocol/x/listing"
	listingmodulekeeper "github.com/bitoro-network/chain/protocol/x/listing/keeper"
	listingmoduletypes "github.com/bitoro-network/chain/protocol/x/listing/types"
	perpetualsmodule "github.com/bitoro-network/chain/protocol/x/perpetuals"
	perpetualsmodulekeeper "github.com/bitoro-network/chain/protocol/x/perpetuals/keeper"
	...
	pricesmodulekeeper "github.com/bitoro-network/chain/protocol/x/prices/keeper"
	pricesmoduletypes "github.com/bitoro-network/chain/protocol/x/prices/types"
	ratelimitmodule "github.com/bitoro-network/chain/protocol/x/ratelimit"
	ratelimitmodulekeeper "github.com/bitoro-network/chain/protocol/x/ratelimit/keeper"
	ratelimitmoduletypes "github.com/bitoro-network/chain/protocol/x/ratelimit/types"
	revsharemodule "github.com/bitoro-network/chain/protocol/x/revshare"
	revsharemodulekeeper "github.com/bitoro-network/chain/protocol/x/revshare/keeper"
	revsharemoduletypes "github.com/bitoro-network/chain/protocol/x/revshare/types"
	rewardsmodule "github.com/bitoro-network/chain/protocol/x/rewards"
	rewardsmodulekeeper "github.com/bitoro-network/chain/protocol/x/rewards/keeper"
	...
	sendingmodulekeeper "github.com/bitoro-network/chain/protocol/x/sending/keeper"
	sendingmoduletypes "github.com/bitoro-network/chain/protocol/x/sending/types"
	statsmodule "github.com/bitoro-network/chain/protocol/x/stats"
	statsmodulekeeper "github.com/bitoro-network/chain/protocol/x/stats/keeper"
	statsmoduletypes "github.com/bitoro-network/chain/protocol/x/stats/types"
	subaccountsmodule "github.com/bitoro-network/chain/protocol/x/subaccounts"
	subaccountsmodulekeeper "github.com/bitoro-network/chain/protocol/x/subaccounts/keeper"
	satypes "github.com/bitoro-network/chain/protocol/x/subaccounts/types"
	vaultmodule "github.com/bitoro-network/chain/protocol/x/vault"
	vaultmodulekeeper "github.com/bitoro-network/chain/protocol/x/vault/keeper"
	...
	vestmodulekeeper "github.com/bitoro-network/chain/protocol/x/vest/keeper"
	...
	// Full Node Streaming
	streaming "github.com/bitoro-network/chain/protocol/streaming"
	streamingtypes "github.com/bitoro-network/chain/protocol/streaming/types"
	"github.com/bitoro-network/chain/protocol/streaming/ws"
)
...
func New(
	...
	// Bitoro specific command-line flags.
	...
	*/
	...
	// This behavior can be invoked via running `bitoroprotocold export`, which exports the chain state to a JSON file.
...
func (app *App) createProposalHandlers(
	...
	// Generate the bitoro handlers
	bitoroPrepareProposalHandler := prepare.PrepareProposalHandler(
		txConfig,
		app.BridgeKeeper,
		app.ClobKeeper,
		app.PerpetualsKeeper,
	...
	var bitoroProcessProposalHandler = process.ProcessProposalHandler(
		txConfig,
		app.BridgeKeeper,
		app.ClobKeeper,
		app.StakingKeeper,
	...
	// Wrap bitoro handlers with slinky handlers
	if appFlags.VEOracleEnabled {
		app.initOracle(priceUpdateDecoder)
		proposalHandler := slinkyproposals.NewProposalHandler(
			app.Logger(),
			bitoroPrepareProposalHandler,
			bitoroProcessProposalHandler,
	...
	return bitoroPrepareProposalHandler, bitoroProcessProposalHandler
}
...
func (app *App) initOracle(pricesTxDecoder process.UpdateMarketPriceTxDecoder) {
	...
	bitoroExtendVoteHandler := vote_extensions.ExtendVoteHandler{
	...
	app.SetExtendVoteHandler(bitoroExtendVoteHandler.ExtendVoteHandler())
