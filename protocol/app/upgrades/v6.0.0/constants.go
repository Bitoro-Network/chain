...
var (
	...
	DefaultMarketMapParams = marketmapmoduletypes.Params{
		MarketAuthorities: []string{"btoro10d07y265gmmuvt4z0w9aw880jnsr700jnmapky"},
	...
	DefaultMarketMap = marketmapmoduletypes.MarketMap{
		Markets: map[string]marketmapmoduletypes.Market{
			...
			"BTORO/USD": {
				Ticker: marketmapmoduletypes.Ticker{
					CurrencyPair:     slinkytypes.CurrencyPair{Base: "BTORO", Quote: "USD"},
					Decimals:         0x9,
					MinProviderCount: 0x3,
					Enabled:          true,
					Metadata_JSON:    "",
				...
				ProviderConfigs: []marketmapmoduletypes.ProviderConfig{
					{Name: "binance_ws", OffChainTicker: "BTOROUSDT",
						NormalizeByPair: &slinkytypes.CurrencyPair{Base: "USDT", Quote: "USD"}, Invert: false, Metadata_JSON: ""},
					{Name: "bybit_ws", OffChainTicker: "BTOROUSDT",
						NormalizeByPair: &slinkytypes.CurrencyPair{Base: "USDT", Quote: "USD"}, Invert: false, Metadata_JSON: ""},
					{Name: "gate_ws", OffChainTicker: "BTORO_USDT",
						NormalizeByPair: &slinkytypes.CurrencyPair{Base: "USDT", Quote: "USD"}, Invert: false, Metadata_JSON: ""},
					{Name: "kucoin_ws", OffChainTicker: "BTORO-USDT",
						NormalizeByPair: &slinkytypes.CurrencyPair{Base: "USDT", Quote: "USD"}, Invert: false, Metadata_JSON: ""},
					{Name: "mexc_ws", OffChainTicker: "BTOROUSDT",
						NormalizeByPair: &slinkytypes.CurrencyPair{Base: "USDT", Quote: "USD"}, Invert: false, Metadata_JSON: ""},
					{Name: "okx_ws", OffChainTicker: "BTORO-USDT",
						NormalizeByPair: &slinkytypes.CurrencyPair{Base: "USDT", Quote: "USD"}, Invert: false, Metadata_JSON: ""},
				},
			},
			"ETC/USD": {
