	...
	tests := map[string]struct {
		...
		"Success: event ID 0": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "btoro1qqgzqvzq2ps8pqys5zcvp58q7rluextx92xhln",
		...
		"Success: event ID 1 - empty address": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "btoro1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq66wm82",
		...
		"Success: event ID 2": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "btoro1qqgzqvzq2ps8pqys5zcvp58q7rluextxzy3rx3z4vemc3xgq42as94fpcv",
		...
		"Success: event ID 3": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				Address:        "btoro124n92ej4ve2kv4tx24n92ej4ve2kv4tx24n92ej4ve2kv4tx24nq8exmjh",
		...
		"Success: event ID 4": {
			...
			expectedEvent: bridgetypes.BridgeEvent{
				...
				// address shorter than 20 bytes is padded with zeros.
				Address:        "btoro1zg6pydqqqqqqqqqqqqqqqqqqqqqqqqqqm0r5ra",
