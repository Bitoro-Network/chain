...
// source: bitoroprotocol/daemons/bridge/bridge.proto
...
import (
	context "context"
	fmt "fmt"
	types "github.com/bitoro-network/chain/protocol/x/bridge/types"
...
func (*AddBridgeEventsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3d6fc1e7bb59d881, []int{0}
}
...
func (*AddBridgeEventsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3d6fc1e7bb59d881, []int{1}
}
...
func init() {
	proto.RegisterType((*AddBridgeEventsRequest)(nil), "bitoroprotocol.daemons.bridge.AddBridgeEventsRequest")
	proto.RegisterType((*AddBridgeEventsResponse)(nil), "bitoroprotocol.daemons.bridge.AddBridgeEventsResponse")
}

func init() {
	proto.RegisterFile("bitoroprotocol/daemons/bridge/bridge.proto", fileDescriptor_3d6fc1e7bb59d881)
}

var fileDescriptor_3d6fc1e7bb59d881 = []byte{
	// 268 bytes of a gzipped FileDescriptorProto
	,
	...
	0xf9, 0xb9, 0xfa, 0x10, 0xb3, 0x75, 0xf3, 0x52, 0x4b, 0xca, 0xf3, 0x8b, 0xb2, 0xf5, 0x93, 0x33,
	0x12, 0x33, 0xf3, 0xf4, 0x71, 0xc5, 0x6b, 0x62, 0x41, 0x66, 0x12, 0x1b, 0x58, 0xd2, 0x18, 0x10,
	0x00, 0x00, 0xff, 0xff, 0x4f, 0xf0, 0x93, 0x07, 0x03, 0x02, 0x00, 0x00,
}
...
func (c *bridgeServiceClient) AddBridgeEvents(ctx context.Context, in *AddBridgeEventsRequest, opts ...grpc.CallOption) (*AddBridgeEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bitoroprotocol.daemons.bridge.BridgeService/AddBridgeEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BridgeService_AddBridgeEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bitoroprotocol.daemons.bridge.BridgeService/AddBridgeEvents",
	}
...
var _BridgeService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bitoroprotocol.daemons.bridge.BridgeService",
	...
	Metadata: "bitoroprotocol/daemons/bridge/bridge.proto",
}
