...
// source: bitoroprotocol/daemons/pricefeed/price_feed.proto
...
func (*UpdateMarketPricesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_04ed115a818e19b9, []int{0}
}
...
func (*UpdateMarketPricesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_04ed115a818e19b9, []int{1}
}
...
func (*ExchangePrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_04ed115a818e19b9, []int{2}
}
...
func (*MarketPriceUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_04ed115a818e19b9, []int{3}
}
...
func init() {
	proto.RegisterType((*UpdateMarketPricesRequest)(nil), "bitoroprotocol.daemons.pricefeed.UpdateMarketPricesRequest")
	proto.RegisterType((*UpdateMarketPricesResponse)(nil), "bitoroprotocol.daemons.pricefeed.UpdateMarketPricesResponse")
	proto.RegisterType((*ExchangePrice)(nil), "bitoroprotocol.daemons.pricefeed.ExchangePrice")
	proto.RegisterType((*MarketPriceUpdate)(nil), "bitoroprotocol.daemons.pricefeed.MarketPriceUpdate")
}

func init() {
	proto.RegisterFile("bitoroprotocol/daemons/pricefeed/price_feed.proto", fileDescriptor_04ed115a818e19b9)
}

var fileDescriptor_04ed115a818e19b9 = []byte{
	// 437 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *priceFeedServiceClient) UpdateMarketPrices(ctx context.Context, in *UpdateMarketPricesRequest, opts ...grpc.CallOption) (*UpdateMarketPricesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/bitoroprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PriceFeedService_UpdateMarketPrices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bitoroprotocol.daemons.pricefeed.PriceFeedService/UpdateMarketPrices",
	}
...
var _PriceFeedService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "bitoroprotocol.daemons.pricefeed.PriceFeedService",
	...
	Metadata: "bitoroprotocol/daemons/pricefeed/price_feed.proto",
}
