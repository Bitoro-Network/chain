...
import (
	...
	txtest "github.com/bitoro-network/chain/protocol/testutil/sdk/tx"
	"github.com/bitoro-network/chain/protocol/x/clob/ante"
...
func runTestCase(t *testing.T, tc TestCase) {
	...
	tx, err := txtest.CreateTestTx(privs, accNums, accSeqs, "bitoro", tc.msgs, tc.timeoutHeight)
