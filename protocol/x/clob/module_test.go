...
import (
	...
	clob_keeper "github.com/Bitoro-Network/chain/protocol/x/clob/keeper"
	"github.com/Bitoro-Network/chain/protocol/x/clob/memclob"
	clob_types "github.com/Bitoro-Network/chain/protocol/x/clob/types"
	"github.com/Bitoro-Network/chain/protocol/x/perpetuals"
	perp_keeper "github.com/Bitoro-Network/chain/protocol/x/perpetuals/keeper"
...
func TestAppModuleBasic_RegisterGRPCGatewayRoutes(t *testing.T) {
	...
	req, err := http.NewRequest("GET", "/bitoroprotocol/clob/clob_pair", nil)
	require.NoError(t, err)
	...
	recorder = httptest.NewRecorder()
	req, err = http.NewRequest("GET", "/bitoroprotocol/clob/clob_pair/0", nil)
	require.NoError(t, err)
	router.ServeHTTP(recorder, req)
	require.Contains(t, recorder.Body.String(), "no RPC client is defined in offline mode")
