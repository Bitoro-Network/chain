...
type QueryVaultResponse struct {
	...
	Equity              github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=equity,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"equity"`
	Inventory           github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=inventory,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"inventory"`
...
type QueryMegavaultOwnerSharesResponse struct {
	...
	Equity github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=equity,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"equity"`
	// Equity that owner can withdraw in quote quantums (as one cannot
	// withdraw locked shares).
	WithdrawableEquity github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,5,opt,name=withdrawable_equity,json=withdrawableEquity,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"withdrawable_equity"`
}
...
type QueryMegavaultWithdrawalInfoResponse struct {
	...
	ExpectedQuoteQuantums github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=expected_quote_quantums,json=expectedQuoteQuantums,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"expected_quote_quantums"`
	// Equity of megavault (in quote quantums).
	MegavaultEquity github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=megavault_equity,json=megavaultEquity,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"megavault_equity"`
...
func init() { proto.RegisterFile("bitoroprotocol/vault/query.proto", fileDescriptor_478fb8dc0ff21ea6) }
