...
type NumShares struct {
	// Number of shares.
	NumShares github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=num_shares,json=numShares,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"num_shares"`
}
...
func init() { proto.RegisterFile("bitoroprotocol/vault/share.proto", fileDescriptor_b65bab3182bbf56c) }
