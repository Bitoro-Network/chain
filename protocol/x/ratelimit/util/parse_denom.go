...
// See chain/protocol/x/ratelimit/LICENSE and chain/protocol/x/ratelimit/README.md for licensing information.
import (
...
//
//	If the chain is acting as a SINK: Add on the Bitoro Chain port and channel and hash it
//	  Ex1: uusdc sent from Noble to Bitoro
//	       Packet Denom:   uusdc
//	        -> Add Prefix: transfer/channel-0/uusdc
//	        -> Hash:       ibc/...
//
//	  Ex2: ujuno sent from Osmosis to Bitoro Chain
...
//	  Ex1: adv4tnt sent back to Bitoro chain from Osmosis
//	       Packet Denom:      transfer/channel-X/adv4tnt
//	        -> Remove Prefix: adv4tnt
//	        -> Leave as is:   adv4tnt
//
//	  Ex2: juno was sent to Bitoro Chain, then to Osmosis, then back to Bitoro Chain
