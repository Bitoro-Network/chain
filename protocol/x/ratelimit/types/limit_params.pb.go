...
type Limiter struct {
	...
	BaselineMinimum github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=baseline_minimum,json=baselineMinimum,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"baseline_minimum"`
...
func init() {
	proto.RegisterFile("bitoroprotocol/ratelimit/limit_params.proto", fileDescriptor_b795558e1de1468a)
}
