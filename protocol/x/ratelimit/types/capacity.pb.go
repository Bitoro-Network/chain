...
type DenomCapacity struct {
	...
	// `LimitParams`.
	CapacityList []github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,rep,name=capacity_list,json=capacityList,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"capacity_list"`
}
...
type LimiterCapacity struct {
	...
	Capacity github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=capacity,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"capacity"`
}
...
func init() {
	proto.RegisterFile("bitoroprotocol/ratelimit/capacity.proto", fileDescriptor_1d7e1de92ba2a318)
}
...
func (m *DenomCapacity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt
