...
// source: bitoroprotocol/perpetuals/perpetual.proto
...
func (PerpetualMarketType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_faee16684a418cba, []int{0}
}
...
type Perpetual struct {
	...
	FundingIndex github_com_bitoro_network_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=funding_index,json=fundingIndex,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"funding_index"`
	// Total size of open long contracts, measured in base_quantums.
	OpenInterest github_com_bitoro_network_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,3,opt,name=open_interest,json=openInterest,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"open_interest"`
}
...
type PerpetualParams struct {
	...
	MarketType PerpetualMarketType `protobuf:"varint,7,opt,name=market_type,json=marketType,proto3,enum=bitoroprotocol.perpetuals.PerpetualMarketType" json:"market_type,omitempty"`
}
...
func (*PerpetualParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_faee16684a418cba, []int{1}
}
...
func (*MarketPremiums) Descriptor() ([]byte, []int) {
	return fileDescriptor_faee16684a418cba, []int{2}
}
...
func (*PremiumStore) Descriptor() ([]byte, []int) {
	return fileDescriptor_faee16684a418cba, []int{3}
}
...
func (*LiquidityTier) Descriptor() ([]byte, []int) {
	return fileDescriptor_faee16684a418cba, []int{4}
}
...
func init() {
	proto.RegisterEnum("bitoroprotocol.perpetuals.PerpetualMarketType", PerpetualMarketType_name, PerpetualMarketType_value)
	proto.RegisterType((*Perpetual)(nil), "bitoroprotocol.perpetuals.Perpetual")
	proto.RegisterType((*PerpetualParams)(nil), "bitoroprotocol.perpetuals.PerpetualParams")
	proto.RegisterType((*MarketPremiums)(nil), "bitoroprotocol.perpetuals.MarketPremiums")
	proto.RegisterType((*PremiumStore)(nil), "bitoroprotocol.perpetuals.PremiumStore")
	proto.RegisterType((*LiquidityTier)(nil), "bitoroprotocol.perpetuals.LiquidityTier")
}

func init() {
	proto.RegisterFile("bitoroprotocol/perpetuals/perpetual.proto", fileDescriptor_faee16684a418cba)
}

var fileDescriptor_faee16684a418cba = []byte{
	// 765 bytes of a gzipped FileDescriptorProto
	,
}
