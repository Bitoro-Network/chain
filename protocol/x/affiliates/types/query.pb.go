...
type AffiliateInfoResponse struct {
	...
	ReferredVolume github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=referred_volume,json=referredVolume,proto3,customtype=github.com/Bitoro-Network/chain/protocol/dtypes.SerializableInt" json:"referred_volume"`
	// The affiliate's currently staked native tokens (in whole coins).
	StakedAmount github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,5,opt,name=staked_amount,json=stakedAmount,proto3,customtype=github.com/Bitoro-Network/chain/protocol/dtypes.SerializableInt" json:"staked_amount"`
}
...
func init() {
	proto.RegisterFile("bitoroprotocol/affiliates/query.proto", fileDescriptor_2edc1b3ea39b05a9)
}
