...
type ListingVaultDepositParams struct {
	...
	NewVaultDepositAmount github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,1,opt,name=new_vault_deposit_amount,json=newVaultDepositAmount,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"new_vault_deposit_amount"`
	// Amount deposited into the main vault exclusively. This amount does not
	// include the amount deposited into the new vault.
	MainVaultDepositAmount github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,2,opt,name=main_vault_deposit_amount,json=mainVaultDepositAmount,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"main_vault_deposit_amount"`
...
func init() { proto.RegisterFile("bitoroprotocol/listing/params.proto", fileDescriptor_051852a22a035387) }
