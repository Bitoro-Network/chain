...
type PerpetualPosition struct {
	...
	QuoteBalance github_com_bitoroprotocol_chain_protocol_dtypes.SerializableInt `protobuf:"bytes,4,opt,name=quote_balance,json=quoteBalance,proto3,customtype=github.com/bitoro-network/chain/protocol/dtypes.SerializableInt" json:"quote_balance"`
}
...
func init() {
	proto.RegisterFile("bitoroprotocol/subaccounts/perpetual_position.proto", fileDescriptor_e659838f8a8f5498)
}
