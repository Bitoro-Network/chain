...
func init() {
	...
	_ = testTxBuilder.SetMsgs(&MsgExecWithBitoroMessage)
	MsgExecWithBitoroMessageTxBytes, _ = testEncodingCfg.TxConfig.TxEncoder()(testTxBuilder.GetTx())
...
var (
	...
	MsgExecWithBitoroMessage = authz.NewMsgExec(
		constants.AliceAccAddress,
		[]sdk.Msg{&sending.MsgCreateTransfer{}},
	)
	MsgExecWithBitoroMessageTxBytes []byte
