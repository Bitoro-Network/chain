...
import (
	...
	"github.com/Bitoro-Network/chain/protocol/testutil/ci"
	...
	return network.Config{
		...
		AppConstructor: func(val network.ValidatorI) servertypes.Application {
			...
			return app.New(
				...
				baseapp.SetChainID("bitoroprotocol"),
			)
		},
		GenesisState:    genesisState,
		TimeoutCommit:   2 * time.Second,
		ChainID:         "bitoroprotocol",
		NumValidators:   1,
...
func NewTestNetworkFixture() network.TestFixture {
	...
	return network.TestFixture{
		...
		GenesisState:   bitoroApp.DefaultGenesis(),
		EncodingConfig: testutil.TestEncodingConfig{
			InterfaceRegistry: bitoroApp.InterfaceRegistry(),
			Codec:             bitoroApp.AppCodec(),
			TxConfig:          bitoroApp.TxConfig(),
			Amino:             bitoroApp.LegacyAmino(),
		},
	}
}
