import { TRADES_WEBSOCKET_MESSAGE_VERSION, KafkaTopics } from '@bitoroprotocol-indexer/kafka';
import { testConstants, TradeContent, TradeMessageContents } from '@bitoroprotocol-indexer/postgres';
import { TradeMessage } from '@bitoroprotocol-indexer/chain-protos';
