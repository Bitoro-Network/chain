import { SUBACCOUNTS_WEBSOCKET_MESSAGE_VERSION } from '@bitoroprotocol-indexer/kafka';
import { testConstants, TradeContent, TradeType } from '@bitoroprotocol-indexer/postgres';
import {
  bigIntToBytes,
