...
import { IndexerTendermintBlock, IndexerTendermintEvent, RegisterAffiliateEventV1 } from '@bitoroprotocol-indexer/chain-protos';
...
function createBlock(
  ...
  const event: IndexerTendermintEvent = createIndexerTendermintEvent(
    BitoroIndexerSubtypes.REGISTER_AFFILIATE,
