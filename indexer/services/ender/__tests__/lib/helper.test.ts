import { IndexerTendermintEvent, IndexerTendermintEvent_BlockEvent } from '@bitoroprotocol-indexer/chain-protos';
import { ParseMessageError } from '@bitoroprotocol-indexer/base';
