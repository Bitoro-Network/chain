...
import { CANDLES_WEBSOCKET_MESSAGE_VERSION } from '@bitoroprotocol-indexer/kafka';
import {
...
import { CandleMessage, CandleMessage_Resolution } from '@bitoroprotocol-indexer/chain-protos';
...
import { ORDERBOOK_MID_PRICES_CACHE_KEY_PREFIX } from '@bitoroprotocol-indexer/redis/build/src/caches/orderbook-mid-prices-cache';
