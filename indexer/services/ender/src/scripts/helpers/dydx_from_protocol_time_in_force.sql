CREATE OR REPLACE FUNCTION bitoro_from_protocol_time_in_force(tif jsonb) RETURNS text AS $$
/**
  Converts the TimeInForce field from an IndexerOrder proto (https://github.com/Bitoro-Network/chain/blob/9ed26bd/proto/bitoroprotocol/indexer/protocol/v1/clob.proto#L94)
