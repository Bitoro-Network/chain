CREATE OR REPLACE FUNCTION bitoro_perpetual_market_v1_handler(event_data jsonb) RETURNS jsonb AS $$
/**
  Note: This is a deprecated handler, see `bitoro_perpetual_market_v2_handler` for the latest handler.
  Parameters:
