CREATE OR REPLACE FUNCTION bitoro_update_perpetual_v2_handler(event_data jsonb) RETURNS jsonb AS $$
/*
  Deprecated; use `bitoro_update_perpetual_v3_handler` instead.
  Parameters:
