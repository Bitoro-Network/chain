CREATE OR REPLACE FUNCTION bitoro_update_perpetual_v1_handler(event_data jsonb) RETURNS jsonb AS $$
/**
  Note: This is a deprecated handler, see `bitoro_update_perpetual_v2_handler` for the latest handler.
  Parameters:
