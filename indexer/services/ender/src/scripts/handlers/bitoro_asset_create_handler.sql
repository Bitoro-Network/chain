CREATE OR REPLACE FUNCTION bitoro_asset_create_handler(event_data jsonb) RETURNS jsonb AS $$
/**
  Parameters:
  ...
  Returns: JSON object containing fields:
    - asset: The created asset in asset-model format (https://github.com/bitoro-network/chain-indexer/blob/cc70982/packages/postgres/src/models/asset-model.ts).
