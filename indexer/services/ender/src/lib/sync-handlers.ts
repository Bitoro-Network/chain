...
import { ConsolidatedKafkaEvent, BitoroIndexerSubtypes, EventMessage } from './types';

// type alias for an array of handlers.
type HandlerBatch = Handler<EventMessage>[];
export const SYNCHRONOUS_SUBTYPES: BitoroIndexerSubtypes[] = [
  BitoroIndexerSubtypes.MARKET,
  BitoroIndexerSubtypes.ASSET,
  BitoroIndexerSubtypes.LIQUIDITY_TIER,
  BitoroIndexerSubtypes.PERPETUAL_MARKET,
  BitoroIndexerSubtypes.UPDATE_PERPETUAL,
  BitoroIndexerSubtypes.UPDATE_CLOB_PAIR,
...
export class SyncHandlers {
   ...
   */
  public addHandler(
    indexerSubtype: BitoroIndexerSubtypes,
