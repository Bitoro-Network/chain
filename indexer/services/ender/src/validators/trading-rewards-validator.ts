import { bytesToBigInt } from '@bitoroprotocol-indexer/chain-proto-parser';
import { IndexerTendermintEvent, TradingRewardsEventV1, AddressTradingReward } from '@bitoroprotocol-indexer/chain-protos';
