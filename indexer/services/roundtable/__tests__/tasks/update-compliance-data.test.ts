...
import { STATS_NO_SAMPLING, logger, stats } from '@bitoroprotocol-indexer/base';
import _ from 'lodash';
import config from '../../src/config';
import { ClientAndProvider } from '../../src/helpers/compliance-clients';
import { ComplianceClientResponse } from '@bitoroprotocol-indexer/compliance';
...
describe('update-compliance-data', () => {
  ...
  it('succeeds with updating multiple addresses, with failures', async () => {
    ...
    const addressWithComplianceError: string = 'btoro1gem4xs643fjhaqvphrvv0adpg4435j7xx9pp4z';
