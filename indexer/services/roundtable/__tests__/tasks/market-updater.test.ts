...
import { wrapBackgroundTask } from '@bitoroprotocol-indexer/base';

import { synchronizeWrapBackgroundTask } from '@bitoroprotocol-indexer/dev';
import { NextFundingCache, redis } from '@bitoroprotocol-indexer/redis';
import { redisClient } from '../../src/helpers/redis';
import Big from 'big.js';
import { DateTime } from 'luxon';
import * as SubaccountTable from '@bitoroprotocol-indexer/postgres/build/src/stores/subaccount-table';
import {
  defaultAsset,
  defaultAsset2,
  defaultAsset3,
  ...
  defaultWallet,
} from '@bitoroprotocol-indexer/postgres/build/__tests__/helpers/constants';
import * as MarketTable from '@bitoroprotocol-indexer/postgres/build/src/stores/market-table';
import * as TendermintEventTable from '@bitoroprotocol-indexer/postgres/build/src/stores/tendermint-event-table';
import * as AssetTable from '@bitoroprotocol-indexer/postgres/build/src/stores/asset-table';
import * as WalletTable from '@bitoroprotocol-indexer/postgres/build/src/stores/wallet-table';

jest.mock('@bitoroprotocol-indexer/base', () => ({
  ...jest.requireActual('@bitoroprotocol-indexer/base'),
