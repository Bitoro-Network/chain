...
import * as LiquidityTiersTable from '@bitoroprotocol-indexer/postgres/build/src/stores/liquidity-tiers-table';
import * as PerpetualMarketTable from '@bitoroprotocol-indexer/postgres/build/src/stores/perpetual-market-table';
