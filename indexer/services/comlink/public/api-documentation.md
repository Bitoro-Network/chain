...
* For **the deployment by BTORO token holders**, use <a href="https://indexer.bitoro.network">https://indexer.bitoro.network</a>
* For **Testnet**, use <a href="https://indexer.testnet.bitoro.foundation">https://indexer.testnet.bitoro.foundation</a>

Note: Messages on Indexer WebSocket feeds are typically more recent than data fetched via Indexer's REST API, because the latter is backed by read replicas of the databases that feed the former. Ordinarily this difference is minimal (less than a second), but it might become prolonged under load. Please see [Indexer Architecture](https://bitoro.foundation/blog/chain-deep-dive-indexer) for more information.
...
# For the deployment by BTORO token holders, use
# baseURL = 'https://indexer.bitoro.network'
baseURL = 'https://indexer.testnet.bitoro.foundation'
...
// For the deployment by BTORO token holders, use
// const baseURL = 'https://indexer.bitoro.network';
const baseURL = 'https://indexer.testnet.bitoro.foundation';
...
# For the deployment by BTORO token holders, use
# baseURL = 'https://indexer.bitoro.network'
baseURL = 'https://indexer.v4testnet.bitoro.foundation'
...
// For the deployment by BTORO token holders, use
// const baseURL = 'https://indexer.bitoro.network';
const baseURL = 'https://indexer.v4testnet.bitoro.foundation';
