...
Bitoro offers a WebSocket API for streaming v4 updates.

You can connect to the v4 Testnet's webSockets at: `wss://indexer.v4testnet.https://bitoro.foundation/ws`
...
`{ "type": "unsubscribe", "channel": "chain_trades", "id": "BTC-USD" }`
...
```tsx
wscli connect wss://indexer.v4testnet.https://bitoro.foundation/ws
<output from ws-cli>
<type 's' to send> { "type": "subscribe", "channel": "chain_trades", "id": "BTC-USD" }
```
...
| channel | string | Set to chain_subaccounts |
...
```tsx
{
  ...
  "message_id": 1,
  "channel": "chain_subaccounts",
  "id": "btoro199tqg4wdlnu4qjlxchpd7seg454937hjrknju4/0",
  "contents": {
    "subaccount": {
...
```tsx
{
  ...
  "message_id": 4,
  "id": "btoro1zsw8fczav25uvc8rg3zcv6zy9j7yhnktpq374m/0",
  "channel": "chain_subaccounts",
  "version": "2.1.0",
  "contents": {
    "orders": [
...
| --- | --- | --- |
| type | string | Set to subscribe |
| channel | string | Set to chain_orderbook |
...
| --- | --- | --- |
| type | string | Set to subscribe |
| channel | string | Set to chain_trades |
| id | string | Set to the ticker of the market you would like to subscribe to. For example, BTC-USD |
...
| --- | --- | --- |
| type | string | Set to subscribe |
| channel | string | Set to chain_markets |
