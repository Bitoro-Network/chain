...
import { stopConsumer, startConsumer } from '@bitoroprotocol-indexer/kafka';
import { blockHeightRefresher, perpetualMarketRefresher } from '@bitoroprotocol-indexer/postgres';
