import { getInstanceId, logger, ParseMessageError } from '@bitoroprotocol-indexer/base';
import {
  ORDERBOOKS_WEBSOCKET_MESSAGE_VERSION,
} from '@bitoroprotocol-indexer/kafka';
import { OrderbookMessageContents, PerpetualMarketFromDatabase, protocolTranslations } from '@bitoroprotocol-indexer/postgres';
import { OffChainUpdateV1, OrderbookMessage, RedisOrder } from '@bitoroprotocol-indexer/chain-protos';
