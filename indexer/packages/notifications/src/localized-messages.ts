...
export const LOCALIZED_MESSAGES: Record<LanguageCode, Record<LocalizationKey, string>> = {
  en: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: 'You have successfully deposited {AMOUNT} {MARKET} to your Bitoro account.',
  ...
  es: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: 'Has depositado exitosamente {AMOUNT} {MARKET} en tu cuenta Bitoro.',
  ...
  fr: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: 'Vous avez déposé avec succès {AMOUNT} {MARKET} sur votre compte Bitoro.',
  ...
  de: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: 'Sie haben erfolgreich {AMOUNT} {MARKET} auf Ihr Bitoro-Konto eingezahlt.',
  ...
  it: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: 'Hai depositato con successo {AMOUNT} {MARKET} sul tuo account Bitoro.',
  ...
  ja: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: 'Bitoroアカウントに{AMOUNT} {MARKET}を正常に入金しました。',
  ...
  ko: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: 'Bitoro 계정에 {AMOUNT} {MARKET}을(를) 성공적으로 입금했습니다.',
  ...
  zh: {
    ...
    [LocalizationBodyKey.DEPOSIT_SUCCESS_BODY]: '您已成功将 {AMOUNT} {MARKET} 存入您的 Bitoro 账户。',
