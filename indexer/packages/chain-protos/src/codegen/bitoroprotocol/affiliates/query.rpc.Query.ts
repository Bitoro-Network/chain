...
export class QueryClientImpl implements Query {
  ...
  affiliateInfo(request: AffiliateInfoRequest): Promise<AffiliateInfoResponse> {
    ...
    const promise = this.rpc.request("bitoroprotocol.affiliates.Query", "AffiliateInfo", data);
  ...
  referredBy(request: ReferredByRequest): Promise<ReferredByResponse> {
    ...
    const promise = this.rpc.request("bitoroprotocol.affiliates.Query", "ReferredBy", data);
  ...
  allAffiliateTiers(request: AllAffiliateTiersRequest = {}): Promise<AllAffiliateTiersResponse> {
    ...
    const promise = this.rpc.request("bitoroprotocol.affiliates.Query", "AllAffiliateTiers", data);
  ...
  affiliateWhitelist(request: AffiliateWhitelistRequest = {}): Promise<AffiliateWhitelistResponse> {
    ...
    const promise = this.rpc.request("bitoroprotocol.affiliates.Query", "AffiliateWhitelist", data);
