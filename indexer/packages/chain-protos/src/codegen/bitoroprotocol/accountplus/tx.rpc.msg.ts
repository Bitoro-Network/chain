...
export class MsgClientImpl implements Msg {
  ...
  addAuthenticator(request: MsgAddAuthenticator): Promise<MsgAddAuthenticatorResponse> {
    ...
    const promise = this.rpc.request("bitoroprotocol.accountplus.Msg", "AddAuthenticator", data);
  ...
  removeAuthenticator(request: MsgRemoveAuthenticator): Promise<MsgRemoveAuthenticatorResponse> {
    ...
    const promise = this.rpc.request("bitoroprotocol.accountplus.Msg", "RemoveAuthenticator", data);
  ...
  setActiveState(request: MsgSetActiveState): Promise<MsgSetActiveStateResponse> {
    ...
    const promise = this.rpc.request("bitoroprotocol.accountplus.Msg", "SetActiveState", data);
