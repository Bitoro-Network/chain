import { IsoString, OrderTable, SubaccountTable } from '@bitoroprotocol-indexer/postgres';
import { ORDER_FLAG_LONG_TERM, ORDER_FLAG_SHORT_TERM } from '@bitoroprotocol-indexer/chain-proto-parser';
import {
  IndexerOrder,
  IndexerOrder_Side,
...
export const address: string = 'bitoroprotocol174e000tqwvszgjxs7yaj844e0m9s6f0m45ws7q';
