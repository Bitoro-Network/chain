import { OrderTable } from '@bitoroprotocol-indexer/postgres';
import { ORDER_FLAG_SHORT_TERM } from '@bitoroprotocol-indexer/chain-proto-parser';
import { RedisOrder } from '@bitoroprotocol-indexer/chain-protos';
