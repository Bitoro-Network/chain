...
import { IndexerOrderId, IndexerOrder_TimeInForce } from '@bitoroprotocol-indexer/chain-protos';
 ...
 * https://github.com/bitoro-network/chain/blob/311411a3ce92230d4866a7c4abb1422fbc4ef3b9/indexer/off_chain_updates/off_chain_updates.go#L293
 * @param orderId
 * @returns
 */
