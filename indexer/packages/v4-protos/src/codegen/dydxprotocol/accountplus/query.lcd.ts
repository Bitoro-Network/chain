...
export class LCDQueryClient {
  ...
  async params(_params: QueryParamsRequest = {}): Promise<QueryParamsResponseSDKType> {
    const endpoint = `bitoroprotocol/accountplus/params`;
  ...
  async getAuthenticator(params: GetAuthenticatorRequest): Promise<GetAuthenticatorResponseSDKType> {
    const endpoint = `bitoroprotocol/accountplus/authenticator/${params.account}/${params.authenticatorId}`;
  ...
  async getAuthenticators(params: GetAuthenticatorsRequest): Promise<GetAuthenticatorsResponseSDKType> {
    const endpoint = `bitoroprotocol/accountplus/authenticators/${params.account}`;
  ...
  async accountState(params: AccountStateRequest): Promise<AccountStateResponseSDKType> {
    const endpoint = `bitoroprotocol/accountplus/account_state/${params.address}`;
