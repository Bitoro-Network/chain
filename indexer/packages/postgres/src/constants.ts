import { CandleMessage_Resolution, ClobPairStatus } from '@bitoroprotocol-indexer/chain-protos';
...
// Sourced from protocol https://github.com/bitoro-network/chain/blob/main/lib/constants.go#L6
