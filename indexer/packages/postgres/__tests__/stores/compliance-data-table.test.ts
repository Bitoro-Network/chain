...
describe('Compliance data store', () => {
  ...
  it('Successfully filters by onlyBitoroAddressWithDeposit', async () => {
  ...
  it('Successfully bulk upserts compliance data', async () => {
    ...
    const otherAddress: string = 'btoro1scu097p2sstqzupe6t687kpc2w4sv665fedctf';
