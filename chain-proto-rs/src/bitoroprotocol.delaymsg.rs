...
impl ::prost::Name for BlockMessageIds {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.BlockMessageIds".into()
    }
...
impl ::prost::Name for DelayedMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.DelayedMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.DelayedMessage".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.GenesisState".into()
    }
...
impl ::prost::Name for QueryNextDelayedMessageIdRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.QueryNextDelayedMessageIdRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.QueryNextDelayedMessageIdRequest".into()
    }
...
impl ::prost::Name for QueryNextDelayedMessageIdResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.QueryNextDelayedMessageIdResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.QueryNextDelayedMessageIdResponse".into()
    }
...
impl ::prost::Name for QueryMessageRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.QueryMessageRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.QueryMessageRequest".into()
    }
...
impl ::prost::Name for QueryMessageResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.QueryMessageResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.QueryMessageResponse".into()
    }
...
impl ::prost::Name for QueryBlockMessageIdsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.QueryBlockMessageIdsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.QueryBlockMessageIdsRequest".into()
    }
...
impl ::prost::Name for QueryBlockMessageIdsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.QueryBlockMessageIdsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.QueryBlockMessageIdsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.delaymsg.Query/NextDelayedMessageId",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.delaymsg.Query",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.delaymsg.Query/Message",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.delaymsg.Query", "Message"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.delaymsg.Query/BlockMessageIds",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.delaymsg.Query", "BlockMessageIds"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
impl ::prost::Name for MsgDelayMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.MsgDelayMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.MsgDelayMessage".into()
    }
...
impl ::prost::Name for MsgDelayMessageResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.delaymsg";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.delaymsg.MsgDelayMessageResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.delaymsg.MsgDelayMessageResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.delaymsg.Msg/DelayMessage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.delaymsg.Msg", "DelayMessage"));
            self.inner.unary(req, path, codec).await
        }
    }
}
