...
impl ::prost::Name for OrderbookMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.socks.OrderbookMessage".into()
    }
...
impl ::prost::Name for SubaccountMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.socks.SubaccountMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.socks.SubaccountMessage".into()
    }
...
impl ::prost::Name for TradeMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.socks.TradeMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.socks.TradeMessage".into()
    }
...
impl ::prost::Name for MarketMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.socks.MarketMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.socks.MarketMessage".into()
    }
...
impl ::prost::Name for CandleMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.socks.CandleMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.socks.CandleMessage".into()
    }
...
impl ::prost::Name for BlockHeightMessage {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.socks";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.socks.BlockHeightMessage".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.socks.BlockHeightMessage".into()
    }
