...
impl ::prost::Name for VestEntry {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.VestEntry".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.vest.GenesisState".into()
    }
...
impl ::prost::Name for QueryVestEntryRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.QueryVestEntryRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.vest.QueryVestEntryRequest".into()
    }
...
impl ::prost::Name for QueryVestEntryResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.QueryVestEntryResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.vest.QueryVestEntryResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.vest.Query/VestEntry",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.vest.Query", "VestEntry"));
...
impl ::prost::Name for MsgDeleteVestEntry {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.MsgDeleteVestEntry".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.vest.MsgDeleteVestEntry".into()
    }
...
impl ::prost::Name for MsgDeleteVestEntryResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.MsgDeleteVestEntryResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.vest.MsgDeleteVestEntryResponse".into()
    }
...
impl ::prost::Name for MsgSetVestEntry {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.MsgSetVestEntry".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.vest.MsgSetVestEntry".into()
    }
...
impl ::prost::Name for MsgSetVestEntryResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.vest";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.vest.MsgSetVestEntryResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.vest.MsgSetVestEntryResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.vest.Msg/SetVestEntry",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.vest.Msg", "SetVestEntry"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.vest.Msg/DeleteVestEntry",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.vest.Msg", "DeleteVestEntry"));
            self.inner.unary(req, path, codec).await
        }
    }
}
