...
impl ::prost::Name for IndexerTendermintEventWrapper {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.indexer_manager";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.indexer_manager.IndexerTendermintEventWrapper".into()
    }
...
impl ::prost::Name for IndexerEventsStoreValue {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.indexer_manager";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.indexer_manager.IndexerEventsStoreValue".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.indexer_manager.IndexerEventsStoreValue".into()
    }
...
impl ::prost::Name for IndexerTendermintEvent {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.indexer_manager";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.indexer_manager.IndexerTendermintEvent".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.indexer_manager.IndexerTendermintEvent".into()
    }
...
impl ::prost::Name for IndexerTendermintBlock {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.indexer_manager";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.indexer_manager.IndexerTendermintBlock".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.indexer_manager.IndexerTendermintBlock".into()
    }
