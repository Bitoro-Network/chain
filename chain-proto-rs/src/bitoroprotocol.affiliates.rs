...
pub mod affiliate_tiers {
    ...
    impl ::prost::Name for Tier {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.affiliates";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.affiliates.AffiliateTiers.Tier".into()
        }
...
impl ::prost::Name for AffiliateTiers {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AffiliateTiers".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AffiliateTiers".into()
    }
...
pub mod affiliate_whitelist {
    ...
    impl ::prost::Name for Tier {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.affiliates";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.affiliates.AffiliateWhitelist.Tier".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.affiliates.AffiliateWhitelist.Tier".into()
        }
...
impl ::prost::Name for AffiliateWhitelist {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AffiliateWhitelist".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AffiliateWhitelist".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.GenesisState".into()
    }
...
impl ::prost::Name for AffiliateInfoRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AffiliateInfoRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AffiliateInfoRequest".into()
    }
...
impl ::prost::Name for AffiliateInfoResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AffiliateInfoResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AffiliateInfoResponse".into()
    }
...
impl ::prost::Name for ReferredByRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.ReferredByRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.ReferredByRequest".into()
    }
...
impl ::prost::Name for ReferredByResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.ReferredByResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.ReferredByResponse".into()
    }
...
impl ::prost::Name for AllAffiliateTiersRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AllAffiliateTiersRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AllAffiliateTiersRequest".into()
    }
...
impl ::prost::Name for AllAffiliateTiersResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AllAffiliateTiersResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AllAffiliateTiersResponse".into()
    }
...
impl ::prost::Name for AffiliateWhitelistRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AffiliateWhitelistRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AffiliateWhitelistRequest".into()
    }
...
impl ::prost::Name for AffiliateWhitelistResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.AffiliateWhitelistResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.AffiliateWhitelistResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.affiliates.Query/AffiliateInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.affiliates.Query", "AffiliateInfo"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.affiliates.Query/ReferredBy",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.affiliates.Query", "ReferredBy"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.affiliates.Query/AllAffiliateTiers",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.affiliates.Query", "AllAffiliateTiers"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.affiliates.Query/AffiliateWhitelist",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.affiliates.Query",
                        "AffiliateWhitelist",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
impl ::prost::Name for MsgRegisterAffiliate {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.MsgRegisterAffiliate".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.MsgRegisterAffiliate".into()
    }
...
impl ::prost::Name for MsgRegisterAffiliateResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.MsgRegisterAffiliateResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.MsgRegisterAffiliateResponse".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateTiers {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.MsgUpdateAffiliateTiers".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.MsgUpdateAffiliateTiers".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateTiersResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.MsgUpdateAffiliateTiersResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.MsgUpdateAffiliateTiersResponse".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateWhitelist {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.MsgUpdateAffiliateWhitelist".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.MsgUpdateAffiliateWhitelist".into()
    }
...
impl ::prost::Name for MsgUpdateAffiliateWhitelistResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.affiliates";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.affiliates.MsgUpdateAffiliateWhitelistResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.affiliates.MsgUpdateAffiliateWhitelistResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.affiliates.Msg/RegisterAffiliate",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.affiliates.Msg", "RegisterAffiliate"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.affiliates.Msg/UpdateAffiliateTiers",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.affiliates.Msg",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.affiliates.Msg/UpdateAffiliateWhitelist",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
