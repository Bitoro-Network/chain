...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.GenesisState".into()
    }
...
impl ::prost::Name for Transfer {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.Transfer".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.Transfer".into()
    }
...
impl ::prost::Name for MsgDepositToSubaccount {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgDepositToSubaccount".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgDepositToSubaccount".into()
    }
...
impl ::prost::Name for MsgWithdrawFromSubaccount {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgWithdrawFromSubaccount".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgWithdrawFromSubaccount".into()
    }
...
impl ::prost::Name for MsgSendFromModuleToAccount {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgSendFromModuleToAccount".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgSendFromModuleToAccount".into()
    }
...
impl ::prost::Name for MsgCreateTransfer {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgCreateTransfer".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgCreateTransfer".into()
    }
...
impl ::prost::Name for MsgCreateTransferResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgCreateTransferResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgCreateTransferResponse".into()
    }
...
impl ::prost::Name for MsgDepositToSubaccountResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgDepositToSubaccountResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgDepositToSubaccountResponse".into()
    }
...
impl ::prost::Name for MsgWithdrawFromSubaccountResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgWithdrawFromSubaccountResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgWithdrawFromSubaccountResponse".into()
    }
...
impl ::prost::Name for MsgSendFromModuleToAccountResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.sending";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.sending.MsgSendFromModuleToAccountResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.sending.MsgSendFromModuleToAccountResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.sending.Msg/CreateTransfer",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.sending.Msg", "CreateTransfer"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.sending.Msg/DepositToSubaccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.sending.Msg", "DepositToSubaccount"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.sending.Msg/WithdrawFromSubaccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.sending.Msg", "WithdrawFromSubaccount"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.sending.Msg/SendFromModuleToAccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.sending.Msg",
