...
impl ::prost::Name for AddBridgeEventsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.daemons.bridge";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.daemons.bridge.AddBridgeEventsRequest".into()
    }
...
impl ::prost::Name for AddBridgeEventsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.daemons.bridge";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.daemons.bridge.AddBridgeEventsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.daemons.bridge.AddBridgeEventsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.daemons.bridge.BridgeService/AddBridgeEvents",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.daemons.bridge.BridgeService",
                        "AddBridgeEvents",
                    ),
                );
