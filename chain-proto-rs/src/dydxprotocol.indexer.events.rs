...
impl ::prost::Name for FundingUpdateV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.FundingUpdateV1".into()
    }
...
impl ::prost::Name for FundingEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.FundingEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.FundingEventV1".into()
    }
...
impl ::prost::Name for MarketEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.MarketEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.MarketEventV1".into()
    }
...
impl ::prost::Name for MarketPriceUpdateEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.MarketPriceUpdateEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.MarketPriceUpdateEventV1".into()
    }
...
impl ::prost::Name for MarketBaseEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.MarketBaseEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.MarketBaseEventV1".into()
    }
...
impl ::prost::Name for MarketCreateEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.MarketCreateEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.MarketCreateEventV1".into()
    }
...
impl ::prost::Name for MarketModifyEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.MarketModifyEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.MarketModifyEventV1".into()
    }
...
impl ::prost::Name for SourceOfFunds {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.SourceOfFunds".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.SourceOfFunds".into()
    }
...
impl ::prost::Name for TransferEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.TransferEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.TransferEventV1".into()
    }
...
impl ::prost::Name for OrderFillEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.OrderFillEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.OrderFillEventV1".into()
    }
...
impl ::prost::Name for DeleveragingEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.DeleveragingEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.DeleveragingEventV1".into()
    }
...
impl ::prost::Name for LiquidationOrderV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.LiquidationOrderV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.LiquidationOrderV1".into()
    }
...
impl ::prost::Name for SubaccountUpdateEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.SubaccountUpdateEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.SubaccountUpdateEventV1".into()
    }
...
pub mod stateful_order_event_v1 {
    ...
    impl ::prost::Name for StatefulOrderPlacementV1 {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.indexer.events.StatefulOrderEventV1.StatefulOrderPlacementV1"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.indexer.events.StatefulOrderEventV1.StatefulOrderPlacementV1"
    ...
    impl ::prost::Name for StatefulOrderRemovalV1 {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.indexer.events.StatefulOrderEventV1.StatefulOrderRemovalV1"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.indexer.events.StatefulOrderEventV1.StatefulOrderRemovalV1"
    ...
    impl ::prost::Name for ConditionalOrderPlacementV1 {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.indexer.events.StatefulOrderEventV1.ConditionalOrderPlacementV1"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.indexer.events.StatefulOrderEventV1.ConditionalOrderPlacementV1"
    ...
    impl ::prost::Name for ConditionalOrderTriggeredV1 {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.indexer.events.StatefulOrderEventV1.ConditionalOrderTriggeredV1"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.indexer.events.StatefulOrderEventV1.ConditionalOrderTriggeredV1"
    ...
    impl ::prost::Name for LongTermOrderPlacementV1 {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.indexer.events.StatefulOrderEventV1.LongTermOrderPlacementV1"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.indexer.events.StatefulOrderEventV1.LongTermOrderPlacementV1"
    ...
    impl ::prost::Name for LongTermOrderReplacementV1 {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.indexer.events.StatefulOrderEventV1.LongTermOrderReplacementV1"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.indexer.events.StatefulOrderEventV1.LongTermOrderReplacementV1"
...
impl ::prost::Name for StatefulOrderEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.StatefulOrderEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.StatefulOrderEventV1".into()
    }
...
impl ::prost::Name for AssetCreateEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.AssetCreateEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.AssetCreateEventV1".into()
    }
...
impl ::prost::Name for PerpetualMarketCreateEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.PerpetualMarketCreateEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.PerpetualMarketCreateEventV1".into()
    }
...
impl ::prost::Name for PerpetualMarketCreateEventV2 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.PerpetualMarketCreateEventV2".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.PerpetualMarketCreateEventV2".into()
    }
...
impl ::prost::Name for LiquidityTierUpsertEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.LiquidityTierUpsertEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.LiquidityTierUpsertEventV1".into()
    }
...
impl ::prost::Name for UpdateClobPairEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.UpdateClobPairEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.UpdateClobPairEventV1".into()
    }
...
impl ::prost::Name for UpdatePerpetualEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.UpdatePerpetualEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.UpdatePerpetualEventV1".into()
    }
...
impl ::prost::Name for TradingRewardsEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.TradingRewardsEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.TradingRewardsEventV1".into()
    }
...
impl ::prost::Name for AddressTradingReward {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.AddressTradingReward".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.AddressTradingReward".into()
    }
...
impl ::prost::Name for OpenInterestUpdateEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.OpenInterestUpdateEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.OpenInterestUpdateEventV1".into()
    }
...
impl ::prost::Name for OpenInterestUpdate {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.OpenInterestUpdate".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.OpenInterestUpdate".into()
    }
...
impl ::prost::Name for LiquidityTierUpsertEventV2 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.LiquidityTierUpsertEventV2".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.LiquidityTierUpsertEventV2".into()
    }
...
impl ::prost::Name for RegisterAffiliateEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.RegisterAffiliateEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.RegisterAffiliateEventV1".into()
    }
...
impl ::prost::Name for UpsertVaultEventV1 {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.indexer.events";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.indexer.events.UpsertVaultEventV1".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.indexer.events.UpsertVaultEventV1".into()
    }
