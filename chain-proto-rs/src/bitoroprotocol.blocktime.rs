...
impl ::prost::Name for BlockInfo {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.BlockInfo".into()
    }
...
pub mod all_downtime_info {
    ...
    impl ::prost::Name for DowntimeInfo {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.blocktime";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.blocktime.AllDowntimeInfo.DowntimeInfo".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.blocktime.AllDowntimeInfo.DowntimeInfo".into()
        }
...
impl ::prost::Name for AllDowntimeInfo {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.AllDowntimeInfo".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.AllDowntimeInfo".into()
    }
...
impl ::prost::Name for DowntimeParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.DowntimeParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.DowntimeParams".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.GenesisState".into()
    }
...
impl ::prost::Name for QueryDowntimeParamsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.QueryDowntimeParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.QueryDowntimeParamsRequest".into()
    }
...
impl ::prost::Name for QueryDowntimeParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.QueryDowntimeParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.QueryDowntimeParamsResponse".into()
    }
...
impl ::prost::Name for QueryPreviousBlockInfoRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.QueryPreviousBlockInfoRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.QueryPreviousBlockInfoRequest".into()
    }
...
impl ::prost::Name for QueryPreviousBlockInfoResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.QueryPreviousBlockInfoResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.QueryPreviousBlockInfoResponse".into()
    }
...
impl ::prost::Name for QueryAllDowntimeInfoRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.QueryAllDowntimeInfoRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.QueryAllDowntimeInfoRequest".into()
    }
...
impl ::prost::Name for QueryAllDowntimeInfoResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.QueryAllDowntimeInfoResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.QueryAllDowntimeInfoResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.blocktime.Query/DowntimeParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.blocktime.Query", "DowntimeParams"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.blocktime.Query/PreviousBlockInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.blocktime.Query", "PreviousBlockInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.blocktime.Query/AllDowntimeInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.blocktime.Query", "AllDowntimeInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
impl ::prost::Name for MsgUpdateDowntimeParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.MsgUpdateDowntimeParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.MsgUpdateDowntimeParams".into()
    }
...
impl ::prost::Name for MsgUpdateDowntimeParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.blocktime";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.blocktime.MsgUpdateDowntimeParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.blocktime.MsgUpdateDowntimeParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.blocktime.Msg/UpdateDowntimeParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.blocktime.Msg", "UpdateDowntimeParams"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
