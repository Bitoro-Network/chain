...
impl ::prost::Name for ListingVaultDepositParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.ListingVaultDepositParams".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.GenesisState".into()
    }
...
impl ::prost::Name for QueryMarketsHardCap {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.QueryMarketsHardCap".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.QueryMarketsHardCap".into()
    }
...
impl ::prost::Name for QueryMarketsHardCapResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.QueryMarketsHardCapResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.QueryMarketsHardCapResponse".into()
    }
...
impl ::prost::Name for QueryListingVaultDepositParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.QueryListingVaultDepositParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.QueryListingVaultDepositParams".into()
    }
...
impl ::prost::Name for QueryListingVaultDepositParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.QueryListingVaultDepositParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.QueryListingVaultDepositParamsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.listing.Query/MarketsHardCap",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.listing.Query", "MarketsHardCap"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.listing.Query/ListingVaultDepositParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.listing.Query",
...
impl ::prost::Name for MsgSetMarketsHardCap {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.MsgSetMarketsHardCap".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.MsgSetMarketsHardCap".into()
    }
...
impl ::prost::Name for MsgSetMarketsHardCapResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.MsgSetMarketsHardCapResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.MsgSetMarketsHardCapResponse".into()
    }
...
impl ::prost::Name for MsgCreateMarketPermissionless {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.MsgCreateMarketPermissionless".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.MsgCreateMarketPermissionless".into()
    }
...
impl ::prost::Name for MsgCreateMarketPermissionlessResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.MsgCreateMarketPermissionlessResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.MsgCreateMarketPermissionlessResponse".into()
    }
...
impl ::prost::Name for MsgSetListingVaultDepositParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.MsgSetListingVaultDepositParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.MsgSetListingVaultDepositParams".into()
    }
...
impl ::prost::Name for MsgSetListingVaultDepositParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.listing";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.listing.MsgSetListingVaultDepositParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.listing.MsgSetListingVaultDepositParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.listing.Msg/SetMarketsHardCap",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.listing.Msg", "SetMarketsHardCap"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.listing.Msg/CreateMarketPermissionless",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.listing.Msg",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.listing.Msg/SetListingVaultDepositParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
