...
impl ::prost::Name for PerpetualFeeParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.PerpetualFeeParams".into()
    }
...
impl ::prost::Name for PerpetualFeeTier {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.PerpetualFeeTier".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.PerpetualFeeTier".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.GenesisState".into()
    }
...
impl ::prost::Name for QueryPerpetualFeeParamsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.QueryPerpetualFeeParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.QueryPerpetualFeeParamsRequest".into()
    }
...
impl ::prost::Name for QueryPerpetualFeeParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.QueryPerpetualFeeParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.QueryPerpetualFeeParamsResponse".into()
    }
...
impl ::prost::Name for QueryUserFeeTierRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.QueryUserFeeTierRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.QueryUserFeeTierRequest".into()
    }
...
impl ::prost::Name for QueryUserFeeTierResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.QueryUserFeeTierResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.QueryUserFeeTierResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.feetiers.Query/PerpetualFeeParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.feetiers.Query", "PerpetualFeeParams"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.feetiers.Query/UserFeeTier",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.feetiers.Query", "UserFeeTier"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
impl ::prost::Name for MsgUpdatePerpetualFeeParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.MsgUpdatePerpetualFeeParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.MsgUpdatePerpetualFeeParams".into()
    }
...
impl ::prost::Name for MsgUpdatePerpetualFeeParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.feetiers";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.feetiers.MsgUpdatePerpetualFeeParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.feetiers.MsgUpdatePerpetualFeeParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.feetiers.Msg/UpdatePerpetualFeeParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.feetiers.Msg",
