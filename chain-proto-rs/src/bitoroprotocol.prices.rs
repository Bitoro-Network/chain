...
impl ::prost::Name for MarketParam {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MarketParam".into()
    }
...
impl ::prost::Name for MarketPrice {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MarketPrice".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.MarketPrice".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.GenesisState".into()
    }
...
impl ::prost::Name for QueryMarketPriceRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryMarketPriceRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryMarketPriceRequest".into()
    }
...
impl ::prost::Name for QueryMarketPriceResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryMarketPriceResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryMarketPriceResponse".into()
    }
...
impl ::prost::Name for QueryAllMarketPricesRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryAllMarketPricesRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryAllMarketPricesRequest".into()
    }
...
impl ::prost::Name for QueryAllMarketPricesResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryAllMarketPricesResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryAllMarketPricesResponse".into()
    }
...
impl ::prost::Name for QueryMarketParamRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryMarketParamRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryMarketParamRequest".into()
    }
...
impl ::prost::Name for QueryMarketParamResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryMarketParamResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryMarketParamResponse".into()
    }
...
impl ::prost::Name for QueryAllMarketParamsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryAllMarketParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryAllMarketParamsRequest".into()
    }
...
impl ::prost::Name for QueryAllMarketParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.QueryAllMarketParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.QueryAllMarketParamsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.prices.Query/MarketPrice",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.prices.Query", "MarketPrice"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.prices.Query/AllMarketPrices",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.prices.Query", "AllMarketPrices"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.prices.Query/MarketParam",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.prices.Query", "MarketParam"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.prices.Query/AllMarketParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.prices.Query", "AllMarketParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
impl ::prost::Name for MsgCreateOracleMarket {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MsgCreateOracleMarket".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.MsgCreateOracleMarket".into()
    }
...
impl ::prost::Name for MsgCreateOracleMarketResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MsgCreateOracleMarketResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.MsgCreateOracleMarketResponse".into()
    }
...
pub mod msg_update_market_prices {
    ...
    impl ::prost::Name for MarketPrice {
        ...
        const PACKAGE: &'static str = "bitoroprotocol.prices";
        fn full_name() -> ::prost::alloc::string::String {
            "bitoroprotocol.prices.MsgUpdateMarketPrices.MarketPrice".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/bitoroprotocol.prices.MsgUpdateMarketPrices.MarketPrice".into()
        }
...
impl ::prost::Name for MsgUpdateMarketPrices {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MsgUpdateMarketPrices".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.MsgUpdateMarketPrices".into()
    }
...
impl ::prost::Name for MsgUpdateMarketPricesResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MsgUpdateMarketPricesResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.MsgUpdateMarketPricesResponse".into()
    }
...
impl ::prost::Name for MsgUpdateMarketParam {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MsgUpdateMarketParam".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.MsgUpdateMarketParam".into()
    }
...
impl ::prost::Name for MsgUpdateMarketParamResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.prices";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.prices.MsgUpdateMarketParamResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.prices.MsgUpdateMarketParamResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.prices.Msg/UpdateMarketPrices",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.prices.Msg", "UpdateMarketPrices"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.prices.Msg/CreateOracleMarket",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.prices.Msg", "CreateOracleMarket"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.prices.Msg/UpdateMarketParam",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.prices.Msg", "UpdateMarketParam"));
            self.inner.unary(req, path, codec).await
        }
    }
}
