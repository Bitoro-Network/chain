...
impl ::prost::Name for LiquidateSubaccountsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.daemons.liquidation";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.daemons.liquidation.LiquidateSubaccountsRequest".into()
    }
...
impl ::prost::Name for LiquidateSubaccountsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.daemons.liquidation";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.daemons.liquidation.LiquidateSubaccountsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.daemons.liquidation.LiquidateSubaccountsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.daemons.liquidation.LiquidationService/LiquidateSubaccounts",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.daemons.liquidation.LiquidationService",
