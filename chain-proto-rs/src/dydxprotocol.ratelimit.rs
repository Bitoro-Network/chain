...
impl ::prost::Name for LimitParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.LimitParams".into()
    }
...
impl ::prost::Name for Limiter {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.Limiter".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.Limiter".into()
    }
...
impl ::prost::Name for DenomCapacity {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.DenomCapacity".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.DenomCapacity".into()
    }
...
impl ::prost::Name for LimiterCapacity {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.LimiterCapacity".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.LimiterCapacity".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.GenesisState".into()
    }
...
impl ::prost::Name for PendingSendPacket {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.PendingSendPacket".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.PendingSendPacket".into()
    }
...
impl ::prost::Name for ListLimitParamsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.ListLimitParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.ListLimitParamsRequest".into()
    }
...
impl ::prost::Name for ListLimitParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.ListLimitParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.ListLimitParamsResponse".into()
    }
...
impl ::prost::Name for QueryCapacityByDenomRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.QueryCapacityByDenomRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.QueryCapacityByDenomRequest".into()
    }
...
impl ::prost::Name for QueryCapacityByDenomResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.QueryCapacityByDenomResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.QueryCapacityByDenomResponse".into()
    }
...
impl ::prost::Name for QueryAllPendingSendPacketsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.QueryAllPendingSendPacketsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.QueryAllPendingSendPacketsRequest".into()
    }
...
impl ::prost::Name for QueryAllPendingSendPacketsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.QueryAllPendingSendPacketsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.QueryAllPendingSendPacketsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.ratelimit.Query/ListLimitParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.ratelimit.Query", "ListLimitParams"),
                );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.ratelimit.Query/CapacityByDenom",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.ratelimit.Query", "CapacityByDenom"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.ratelimit.Query/AllPendingSendPackets",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.ratelimit.Query",
...
impl ::prost::Name for MsgSetLimitParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.MsgSetLimitParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.MsgSetLimitParams".into()
    }
...
impl ::prost::Name for MsgSetLimitParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.ratelimit";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.ratelimit.MsgSetLimitParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.ratelimit.MsgSetLimitParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.ratelimit.Msg/SetLimitParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.ratelimit.Msg", "SetLimitParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
