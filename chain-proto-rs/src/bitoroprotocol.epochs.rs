...
impl ::prost::Name for EpochInfo {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.epochs";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.epochs.EpochInfo".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.epochs";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.epochs.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.epochs.GenesisState".into()
    }
...
impl ::prost::Name for QueryGetEpochInfoRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.epochs";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.epochs.QueryGetEpochInfoRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.epochs.QueryGetEpochInfoRequest".into()
    }
...
impl ::prost::Name for QueryEpochInfoResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.epochs";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.epochs.QueryEpochInfoResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.epochs.QueryEpochInfoResponse".into()
    }
...
impl ::prost::Name for QueryAllEpochInfoRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.epochs";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.epochs.QueryAllEpochInfoRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.epochs.QueryAllEpochInfoRequest".into()
    }
...
impl ::prost::Name for QueryEpochInfoAllResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.epochs";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.epochs.QueryEpochInfoAllResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.epochs.QueryEpochInfoAllResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.epochs.Query/EpochInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.epochs.Query", "EpochInfo"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.epochs.Query/EpochInfoAll",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.epochs.Query", "EpochInfoAll"));
            self.inner.unary(req, path, codec).await
        }
    }
}
