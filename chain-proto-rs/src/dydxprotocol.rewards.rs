...
impl ::prost::Name for Params {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.rewards";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.rewards.Params".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.rewards";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.rewards.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.rewards.GenesisState".into()
    }
...
impl ::prost::Name for QueryParamsRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.rewards";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.rewards.QueryParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.rewards.QueryParamsRequest".into()
    }
...
impl ::prost::Name for QueryParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.rewards";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.rewards.QueryParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.rewards.QueryParamsResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.rewards.Query/Params",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.rewards.Query", "Params"));
...
impl ::prost::Name for RewardShare {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.rewards";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.rewards.RewardShare".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.rewards.RewardShare".into()
    }
...
impl ::prost::Name for MsgUpdateParams {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.rewards";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.rewards.MsgUpdateParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.rewards.MsgUpdateParams".into()
    }
...
impl ::prost::Name for MsgUpdateParamsResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.rewards";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.rewards.MsgUpdateParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.rewards.MsgUpdateParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.rewards.Msg/UpdateParams",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.rewards.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
