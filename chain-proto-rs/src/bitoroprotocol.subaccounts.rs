...
impl ::prost::Name for AssetPosition {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.AssetPosition".into()
    }
...
impl ::prost::Name for PerpetualPosition {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.PerpetualPosition".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.PerpetualPosition".into()
    }
...
impl ::prost::Name for SubaccountId {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.SubaccountId".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.SubaccountId".into()
    }
...
impl ::prost::Name for Subaccount {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.Subaccount".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.Subaccount".into()
    }
...
impl ::prost::Name for StreamSubaccountUpdate {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.StreamSubaccountUpdate".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.StreamSubaccountUpdate".into()
    }
...
impl ::prost::Name for SubaccountPerpetualPosition {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.SubaccountPerpetualPosition".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.SubaccountPerpetualPosition".into()
    }
...
impl ::prost::Name for SubaccountAssetPosition {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.SubaccountAssetPosition".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.SubaccountAssetPosition".into()
    }
...
impl ::prost::Name for GenesisState {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.GenesisState".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.GenesisState".into()
    }
...
impl ::prost::Name for QueryGetSubaccountRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QueryGetSubaccountRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QueryGetSubaccountRequest".into()
    }
...
impl ::prost::Name for QuerySubaccountResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QuerySubaccountResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QuerySubaccountResponse".into()
    }
...
impl ::prost::Name for QueryAllSubaccountRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QueryAllSubaccountRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QueryAllSubaccountRequest".into()
    }
...
impl ::prost::Name for QuerySubaccountAllResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QuerySubaccountAllResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QuerySubaccountAllResponse".into()
    }
...
impl ::prost::Name for QueryGetWithdrawalAndTransfersBlockedInfoRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QueryGetWithdrawalAndTransfersBlockedInfoRequest"
            .into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QueryGetWithdrawalAndTransfersBlockedInfoRequest"
...
impl ::prost::Name for QueryGetWithdrawalAndTransfersBlockedInfoResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QueryGetWithdrawalAndTransfersBlockedInfoResponse"
            .into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QueryGetWithdrawalAndTransfersBlockedInfoResponse"
...
impl ::prost::Name for QueryCollateralPoolAddressRequest {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QueryCollateralPoolAddressRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QueryCollateralPoolAddressRequest".into()
    }
...
impl ::prost::Name for QueryCollateralPoolAddressResponse {
    ...
    const PACKAGE: &'static str = "bitoroprotocol.subaccounts";
    fn full_name() -> ::prost::alloc::string::String {
        "bitoroprotocol.subaccounts.QueryCollateralPoolAddressResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/bitoroprotocol.subaccounts.QueryCollateralPoolAddressResponse".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.subaccounts.Query/Subaccount",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bitoroprotocol.subaccounts.Query", "Subaccount"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.subaccounts.Query/SubaccountAll",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("bitoroprotocol.subaccounts.Query", "SubaccountAll"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.subaccounts.Query/GetWithdrawalAndTransfersBlockedInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "bitoroprotocol.subaccounts.Query",
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bitoroprotocol.subaccounts.Query/CollateralPoolAddress",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
